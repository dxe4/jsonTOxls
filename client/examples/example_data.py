...
import datetime
import random
from common import common_data_structures,common_date
...
class Example4:
    ...
    def random_days_dict(self):
        ...
        arrival_list = []
        for i in range(1,10):
            departure_date,arrival_date = common_date.random_dates_sorted(year=2013)
    ...
    def create_data(self):
        data = {}
        for i in range(1,10):
            departure_location,arrival_location = common_data_structures.random_list_item(self.locations),common_data_structures.random_list_item(self.locations)
